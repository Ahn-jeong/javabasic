...
public class SampleClass {
	...
	String method3(){
		...
		//리턴타입이 없는 매서드에서는 메서드를 종료시킨다.
	}
	
	int method4(int a, int b){
		System.out.println(a+ "," + b + " 를 사용해 명령을 실행시키고"  + " 결과물을 돌려주는 메서드");
		return a + b;
	}
	...
	void test1(){
		...
		test3();
		System.out.println("6. text1 종료"); 
	}
	
	void test2(){
		System.out.println("3. test2 시작"); 
		System.out.println("4. text2 종료"); 
	}
	
	void test3(){
		System.out.println("2. test3 시작"); 
		test2();
		System.out.println("5. text3 종료"); 
	}
