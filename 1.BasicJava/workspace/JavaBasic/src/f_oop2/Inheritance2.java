...
public class Inheritance2 {
	...
	public static void main(String[] args) {
		 ...
		 *  - abstract class 클래스명{}
		 *  - 추상클래스는 객체를 생성할 수 없고, 부모 클래스의 역할만 할수 있다.
		 *  
		 *  << 인터페이스 >>
		 ...
		 *  - 지역 클래스 : 메서드나 초기화블럭 안에 사용되며,
		 *    선언된 영역 내부에서만 사용될 수 있다.
		 *  - 익명 클래스 : 이름이없고, 선언과 객체 생성을 동시에 한다.(일회용)  
		 */
		 ...
		 * - AWT, Swing, JavaFX
		 * 
		 * CUI : Charater User Interface의 약자(Command-line Interface)
