...
public class Inheritance {
	...
	public static void main(String[] args) {
		 ...
		 * - 상속받은 메서드보다 좁은 범위의 접근제어자로 변결할 수 없다.
		 * - 상속받은 메서드보다 많은 예외을 선언할 수 없다.
		 * - static을 빼거나 더할수 없다.
		 * 
		 * << 다형성 >>
...
//		t.setSecond(59);
//		
//		System.out.println(t); // << toString 메소드의 내용을 변경함(주소에서 - > 출력하고싶은내용)
		
		
		
		Singleton s = Singleton.getInstance();
		
		System.out.println(new Inheritance()); // 서로다른객체
		System.out.println(new Inheritance());
		System.out.println(Singleton.getInstance()); //같은객체
