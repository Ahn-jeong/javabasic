...
public class Controller {
	...
	private void adminMenu() {// 관리자 관리 화면
		while (true) {
			...
			switch (select) {
			case 1:
				adminService.procMag();
				break;
			case 2:
				adminService.stdtMag();
				break;
			case 3:
				adminService.subMag();
				break;
	...
	private void prMenu() {// 교수 관리 화면
		while (true) {
			...
			switch (select) {
			case 1:
				professorService.info();
				break;
			case 2:
				professorService.lectureManage();
				break;
			case 3:
				professorService.searchProf();
				break;
			case 4:
				professorService.searchSt();
				break;
			case 0:
				ProfSession.loginprof = null;
				return;
			default:
				break;
			}
	...
	private void stMenu() {
		while (true) {
			...
			switch (select) {
			case 1:
				studentService.Stuinfo();
				break;
			case 2:
				studentService.lecinfo();
				break;
			case 3:
				studentService.myLeclist();
				break;
	        case 4 : studentService.nowSearchGrade(); 
	        	break;	        	
			case 5 : studentService.allSearchGrade(); 
				break;
			case 0: 
				StuSession.loginstu = null;				
				return;				
			default:
				break;
			}
